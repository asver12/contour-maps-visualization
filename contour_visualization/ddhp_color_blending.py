...
def blend_rgb_colors(front_rgb, back_rgb, alpha, verbose=False):
    ...
    if verbose:
        ...
        print("Result: {}".format(
            color_converter.rgb01_to_rgb255(int_to_array(lib.blend_rgb_colors(front_rgb_int, back_rgb_int, alpha)))))
...
if __name__ == "__main__":
    ...
    print("Result: {}".format(color_converter.rgb01_to_rgb255(
        blend_rgb_colors(color_converter.rgb255_to_rgb01(rgb_front), color_converter.rgb255_to_rgb01(rgb_back),
                         alpha))))
